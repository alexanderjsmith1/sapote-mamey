...
REGISTRY = ROOT / "bundle_support/registry_inventory_v1.9.4.json"
REGISTRY_BACKED = {
...
def registry_only_rows() -> list[dict[str, Any]]:
    ...
    for entry in inventory:
        ...
        if entry.get("library") in mamey_libraries and types & {"regex", "motif"}:
            continue
        rows.append(_row(module="bundle_support/registry_inventory_v1.9.4.json", line="", scan=entry.get("library", ""),
