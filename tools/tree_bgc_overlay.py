...
ANI/BGC/domain/Mode-B annotations. Those evidence channels meet only through an
...
ANNOTATION_CHANNELS = frozenset({"ANI", "BGC", "DOMAIN", "MODE_B", "ASSEMBLY"})
TRACK_COLORS = {
    "ANI": "#0072B2", "BGC": "#009E73", "DOMAIN": "#E69F00",
    "MODE_B": "#CC79A7", "ASSEMBLY": "#666666",
}
CLAIM_CEILING = (
    "MLSA, core-genome topology, ANI, BGC, domain, and Mode B evidence remain separate. "
