...
It then enforces:
  ...
  - MANIFEST parity: docs/BUNDLE_CAPABILITIES.md, docs/DELIVERABLE_MANIFEST_TEMPLATE.md,
...
MANIFEST_FILES = ["docs/BUNDLE_CAPABILITIES.md", "docs/DELIVERABLE_MANIFEST_TEMPLATE.md",
...
def inspect(zpath):
    ...
    try:
        ...
        # registry + manifests
        info["registry_present"] = os.path.exists(os.path.join(root, "bundle_support/registry_inventory_v1.9.4.json"))
