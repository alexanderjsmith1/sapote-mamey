...
same audit: `docs/FIGURES_START_HERE.md` named a `build_bee_wasp_master_figures.py` that does not exist
...
META_SKIP = {"docs/EXAMPLES_REFERENCE_LEDGER.md"}
...
TOOLS_ALLOW = {
    ...
    "bunny_hop_audit_game.py": "debugging_modules/ tree, not shipped in the code tiers — docs/user_guides/tools_reference.md",
