...
DELIVERABLE_MANIFEST_<strain>.md (from DELIVERABLE_MANIFEST_TEMPLATE.md) and fails closed on:
...
def check(text, mode):
    ...
    # token PASS or FAIL. DELIVERABLE_MANIFEST_TEMPLATE.md ships this line with the unfilled
