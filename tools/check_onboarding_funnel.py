...
# FIGURES_START_HERE.md is the figures subsystem's door (it funnels into the figure-prompt
...
EXEMPT = {
    "FIGURES_START_HERE.md": "figures subsystem door, not an agent run-pipeline entry point",
}
