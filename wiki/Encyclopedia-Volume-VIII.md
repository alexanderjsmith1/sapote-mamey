...
*Edition: bundle v9.7.33 / engine Mamey 1.9.41 · re-grounded to bundle v9.7.91 / engine Mamey 1.9.91 on 2026-06-20 (the three denominator_type values, all nine KCB BGCRecord fields, the registry_inventory_v1.9.4.json SSOT + the \_NON_REGISTRY parity set, and the \_RULE_FLAG / \_OWN_PRODUCTS_ONLY standing-rule map all re-verified against the running engine; §VII.9 relocated to Volume VII and §VIII.7 brought inside this volume) · 2026-06-16*
...
**CCTT / T43**: the class-corroborating trigger framework, fifteen gene-signature families (§IV.3). A trigger is a
...
| Artifact | Role |
|----|----|
| `registry_inventory_v1.9.4.json` | the runtime SSOT — the registry-backed detector reads marker values from here |
