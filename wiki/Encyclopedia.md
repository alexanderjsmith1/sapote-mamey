...
(lead boards, Mode B verdict layer, cross-strain merge) current to bundle v9.7.414 / engine Mamey 1.9.152,
...
The CCTT T43 trigger framework and its fifteen families (AMC, BLA, DKP, ENE, HAL, IDC, LAN, LASSO, NN, NUC,
