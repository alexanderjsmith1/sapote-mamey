"""_console.py — the single owner of direct terminal emission for deliverable_tools/ (sibling copy of tools/_console.py — a standalone tool must not need the other directory on sys.path).
