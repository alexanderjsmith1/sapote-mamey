...
import os, re, csv, hashlib, glob
from collections import defaultdict

PW = os.environ.get("SAPOTE_WORKSPACE_ROOT", os.getcwd()) + "/sessions/Amber/phylo_work"
OUT = os.environ.get("SAPOTE_WORKSPACE_ROOT", os.getcwd()) + "/sapote_deliverables/WORKING_GENOME_SET_2026-08-03"
