# Sapote-Mamey Bundle Release Manifest — v9.7.435 CODE archive

**Cut/build date:** 2026-09-20
**Artifact status:** validated CODE archive  
**Bundle version:** `sapote-mamey-v9.7.435`  
**Authoritative bundle version:** `9.7.435`  
**Engine:** Mamey v1.9.167  
**Build stamp:** 20260920v97435a  
...
| Gate | Status |
|---|---|
| Full pytest suite | PASS (11591 passed, 239 skipped; receipt-bound log) |
...
Naming rule for any future multi-tier release: All four tiers share build stamp `20260920v97435a`. No such tier set was built here.

| Gate | Status |
|---|---|
| `sync_version --check` | PASS (engine 1.9.167, bundle 9.7.435) |

All tracked version anchors at v9.7.435 / Mamey 1.9.167.
`MAMEY_CHATGPT_EXECUTION_PROMPT.md` updated to v9.7.435.

*Generated: 2026-09-20 | Sapote-Mamey Bundle v9.7.435 | NOT_FOR_PUBLIC_RELEASE*
