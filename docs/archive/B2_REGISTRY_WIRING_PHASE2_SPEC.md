...
HMM target is self-describing. This is a data edit to `registry_inventory_v1.9.4.json`, not code.
...
(e) updated `registry_inventory_v1.9.4.json`. Claude will re-verify parity, vet each new call
