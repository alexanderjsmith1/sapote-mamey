...
*Operating guide for the Sapote–Mamey genome-mining pipeline · current to bundle v9.7.441 / engine Mamey 1.9.169*
...
*(engine 1.9.169, bundle v9.7.441)*
...
Use an isolated environment rather than overriding system Python protections:
...
python3 tools/sync_version.py --check # should report `engine 1.9.169, bundle 9.7.441`
...
*Sapote–Mamey User Manual · current to bundle v9.7.441 / engine Mamey 1.9.169 Consolidates the former 01_User_Guide.md and 01_User_Manual.html into one task-flow-first operating manual; deep internals live in the Encyclopedia, term definitions in GLOSSARY.md.*
