...
*Current to bundle v9.7.431 / engine Mamey 1.9.165.*
...
*Sapote–Mamey Concepts Q&A · current to bundle v9.7.431 / engine Mamey 1.9.165 A running document — concepts are version-stable; inline version references (e.g. "shipped in v9.7.91", "v9.7.97 CODE tier") are historical record, not a currency claim. Companion to `../GLOSSARY.md` (definitions) and `03_Technical_Manual_Encyclopedia.html` (deep internals); Q&A is the conversational "why does it work this way" layer.*
