...
| Human-friendly walkthrough | `README.md` | 15 min | Non-developers |
| Know exactly where to start | `AGENTS.md` or `AGENTS.md` | 10 min | LLM operators |
| Check dependencies | `docs/PREREQUISITES.md` | 2 min | Developers |
...
| Validate a package after Mamey | `docs/BUNDLE_CAPABILITIES.md` § 0.6 (Post-MAMEY handback) | 3 min | Operators |
...
| Know which BGCs to pick for Mode B | `docs/BUNDLE_CAPABILITIES.md` § 1 (Analysis modes) | 5 min | Operators |
...
| See the first-pass scans (KCB, FLBR, UMED, etc.) | `docs/GUIDE/02_Quick_Guide.md` or `docs/BUNDLE_CAPABILITIES.md` § 1.5 | 5 min | Everyone |
...
| Learn how to cite properly | `docs/GUIDE/06_Concepts_QandA.md` (search "citation") or `AGENTS.md` § 1 (non-negotiable framing) | 5 min | Everyone |
...
| Export data for figures | `docs/BUNDLE_CAPABILITIES.md` § 2 (Tool: export_figure_ready.py) | 3 min | Figure makers |
| Merge multiple strains into a master workbook | `docs/BUNDLE_CAPABILITIES.md` § 2 (Tool: hub_merge.py) | 5 min | Cohort builders |
| Find a specific BGC or field | `batch01_tools_discoverability_map.md` (search task-based flowchart) | 3 min | Everyone |
| Validate workbook schema after edits | `docs/BUNDLE_CAPABILITIES.md` § 2 (Tool: schema_deployed_audit.py) | 3 min | Data QA |
...
| Find available figures (catalog) | `docs/FIGURES_START_HERE.md` (in bundle root) | 5 min | Everyone |
| Build a figure from data | `docs/BUNDLE_CAPABILITIES.md` § 2 (Tool: build_figures.py) | 5 min | Technical |
| Make a multi-panel figure | `docs/BUNDLE_CAPABILITIES.md` § 2 (Tool: build_panel_figure.py) | 5 min | Technical |
| Create an interactive HTML atlas | `docs/BUNDLE_CAPABILITIES.md` § 2 (Tool: generate_bgc_atlas.py) | 5 min | Technical |
...
| Write a Wet-Lab Decision Matrix | `docs/BUNDLE_CAPABILITIES.md` § 2 (Tool: build_wetlab_matrix.py) | 5 min | Operators |
...
| Check deliverable completion | `docs/BUNDLE_CAPABILITIES.md` § 2 (Tool: check_deliverable_suite.py) | 3 min | QA |
...
| I want to... | Read this | Time | Audience |
|--------------|-----------|------|----------|
| Merge multiple strains' workbooks | `docs/BUNDLE_CAPABILITIES.md` § 2 (Tool: hub_merge.py) or `batch01_tools_discoverability_map.md` § Cross-Strain | 5 min | Technical |
| Handle fragmentation across strains | `batch04_gotcha_guide.md` § 3.2 or `docs/BUNDLE_CAPABILITIES.md` § 2 (Tool: build_normalization_matrix.py) | 10 min | Comparative |
| Compare BGCs across strains (pan-genome) | `docs/BUNDLE_CAPABILITIES.md` § 2 (Tool: build_pangenome.py) | 5 min | Comparative |
| Do cross-strain figures | `docs/BUNDLE_CAPABILITIES.md` § 2 (Tool: build_cross_strain_figures.py) | 5 min | Figures |
...
| Understand tier differences | `docs/TIER_DIFFERENCES.md` | 10 min | Release managers |
| Cut a release | `docs/BUNDLE_CAPABILITIES.md` § 3 (Tool: release.sh) | 5 min | Operators |
| Make a public tier (anonymize AS strains) | `docs/BUNDLE_CAPABILITIES.md` § 2 (Tool: redact_public_tier.py) | 5 min | Release QA |
| Verify tier parity | `docs/BUNDLE_CAPABILITIES.md` § 2 (Tool: check_tier_parity.py) | 3 min | QA |
| Verify SHA256 checksums | `docs/BUNDLE_CAPABILITIES.md` § 2 (Tool: emit_release_sums.sh) | 3 min | QA |
| Check for data leaks before public release | `docs/BUNDLE_CAPABILITIES.md` § 2 (Tool: audit_public_cut.py) | 3 min | Release QA |
...
| Check operator next steps | `docs/PLAYBOOK.md` | 10 min | Decision-making |
...
| Know the command menu | `docs/BUNDLE_CAPABILITIES.md` | 20 min | Operators |
...
| Maintain bootstrap surfaces | `docs/BUNDLE_CAPABILITIES.md` § 2 (Tool: render_bootstrap_contract.py) | 5 min | Maintenance |
| Regenerate the tools inventory | `docs/BUNDLE_CAPABILITIES.md` § 2 (Tool: gen_tools_inventory.py) | 3 min | Maintenance |
...
| `README.md` | Human-friendly walkthrough | You prefer guided narrative |
| `AGENTS.md` | ChatGPT execution contract | Running in ChatGPT |
| `AGENTS.md` | Claude execution contract | Running in Claude |
| `docs/PLAYBOOK.md` | Operator decision trees | You need to decide what to do next |
| `docs/BUNDLE_CAPABILITIES.md` | Command menu + tool catalog | You've started and need options |
...
1. `AGENTS.md` or `AGENTS.md` (read once, bookmark)
