...
| **Registry** | 200 KB | `registry_inventory_v1.9.4.json` (156 entries) |
...
|------|---------|--------|
| `000_READ_ME_FIRST_CHATGPT_CLAUDE.md` | Bootstrap router | Active |
| `CHATGPT_START_HERE.md` | ChatGPT execution spec | Active |
| `CLAUDE_START_HERE.md` | Claude execution spec | Active |
| `README_START_HERE.md` | Human reading order | Active |
| `README.md` | Project overview | Active |
| `PLAYBOOK.md` | Operator decision trees | Active |
| `SESSION_START_MANIFEST.md` | Command menu + catalog | Active |
| `CURRENT_DOCS_INDEX.md` | Doc index | Active |
| `TIER_DIFFERENCES.md` | Tier architecture | Active |
| `RELEASES_LOG.md` | Release history | Active |
| `PREREQUISITES.md` | Python requirements | Active |
...
| `project_state_template.json` | Session state | Template |
...
**Verified:**
- `registry_inventory_v1.9.4.json` — **200 KB**, 156 registry entries (domain classes, CCTT markers, CGAD patterns, resistance markers, etc.)
...
**Registry:**
- `registry_inventory_v1.9.4.json` (~5 MB, KCB reference database)
...
- **Tier architecture:** `TIER_DIFFERENCES.md`
