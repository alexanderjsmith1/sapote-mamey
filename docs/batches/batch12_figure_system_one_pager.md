...
1. **Check:** Does the figure already exist? See catalog below or `FIGURES_START_HERE.md`
...
**See also:** `FIGURES_START_HERE.md` in bundle root (full catalog with links to prompts).
...
| Can't find a figure ID | Check `FIGURES_START_HERE.md` catalog; request new figure if not listed |
...
| File | Purpose |
|------|---------|
| `FIGURES_START_HERE.md` | Figure catalog + prompt library index |
...
- **Figure catalog:** `FIGURES_START_HERE.md` (full index)
