...
1. `CHATGPT_START_HERE.md` or `CLAUDE_START_HERE.md` ← bundle root
...
| File | What it is |
|------|-----------|
| `SESSION_START_MANIFEST.md` | Command menu + tool catalog (start every session here) |
| `CHATGPT_START_HERE.md` | ChatGPT execution contract |
| `CLAUDE_START_HERE.md` | Claude execution contract |
