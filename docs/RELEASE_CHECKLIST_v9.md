...
- [ ] Every full run emitted a filled `DELIVERABLE_MANIFEST_<strain>.md` (from `DELIVERABLE_MANIFEST_TEMPLATE.md`).
...
- [ ] Tier parity: cassette stable IDs, `registry_inventory_v1.9.4.json`, and the manifests are present in ALL four tiers (the v9.7.5 gap was CODE-analysis-free shipping placeholder IDs + missing registry).
