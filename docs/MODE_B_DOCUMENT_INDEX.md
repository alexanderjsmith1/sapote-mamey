...
| Older prompt files under `prompts/` and standalone docs | May be superseded by `AGENTS.md`. Use only after checking version stamps and current-start-file guidance. |
