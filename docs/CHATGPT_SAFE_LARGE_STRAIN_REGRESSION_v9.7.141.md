...
`gold --chatgpt-safe` run before re-reading `CHATGPT_START_HERE.md`. The run began cleanly,
...
1. Read canonical `CHATGPT_START_HERE.md` first; `CHATGTP_READ_ME_FIRST.md` is optional typo rescue only.
