...
(`README_START_HERE.md`, `CLAUDE_START_HERE.md`, `CURRENT_DOCS_INDEX.md`, `PREREQUISITES.md`).
...
- **How:** **rebuild it from the full Pfam-A** with the shipped builder (documented in `PREREQUISITES.md`),
