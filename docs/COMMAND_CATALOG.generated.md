...
*Generated from the live argparse tree of `mamey.cli` by `tools/gen_command_catalog.py` — bundle v9.7.440 · engine 1.9.169. Do not edit by hand; `--check` fails the build when stale.*
