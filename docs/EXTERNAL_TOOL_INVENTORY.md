...
**Bundle v9.7.414 · engine Mamey 1.9.152 · compiled 2026-09-07**
...
of this table lives in `THIRD_PARTY_LICENSES.md`.
...
Cross-references: `PREREQUISITES.md` (Python-side dependencies and offline wheels) ·
