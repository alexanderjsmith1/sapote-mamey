...
`registry_inventory_v1.9.4.json` via `registry_detector.build_pattern_dicts()`
...
- Bundle `9.7.6 → 9.7.7` (`CITATION.cff`, `SESSION_START_MANIFEST.md`, reuse-prompt headers).
