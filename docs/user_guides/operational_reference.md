...
```bash
unzip sapote-mamey-v9.7.437-CODE-20260921v97437a.zip
cd sapote-mamey-v9.7.437-CODE-20260921v97437a
pip install -e .
...
python3 tools/sync_version.py --check # → engine 1.9.167, bundle 9.7.437
...
*Version synchronized at cut time · Bundle v9.7.437. Historical run facts retain their original version labels.*
...
*Version synchronized at cut time · Bundle v9.7.437. Historical v4 section labels and run facts retain their original version labels.*
