...
```bash
unzip sapote-mamey-v9.7.440-CODE-20260922v97440c.zip
cd sapote-mamey-v9.7.440-CODE-20260922v97440c
pip install -e .
...
python3 tools/sync_version.py --check # → engine 1.9.169, bundle 9.7.440
...
*Version synchronized at cut time · Bundle v9.7.440. Historical run facts retain their original version labels.*
...
*Version synchronized at cut time · Bundle v9.7.440. Historical v4 section labels and run facts retain their original version labels.*
