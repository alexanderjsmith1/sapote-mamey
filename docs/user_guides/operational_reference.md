...
```bash
unzip sapote-mamey-v9.7.441-CODE-20260924v97441b.zip
cd sapote-mamey-v9.7.441-CODE-20260924v97441b
pip install -e .
...
```bash
bash bundle_support/install_sapote_addons.sh           # auto-discovers every attached addon part
...
python3 tools/sync_version.py --check # → engine 1.9.169, bundle 9.7.441
...
*Version synchronized at cut time · Bundle v9.7.441. Historical run facts retain their original version labels.*
...
*Version synchronized at cut time · Bundle v9.7.441. Historical v4 section labels and run facts retain their original version labels.*
