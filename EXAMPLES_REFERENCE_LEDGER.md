...
| `examples/test_data/test_master.xlsx` | `PREREQUISITES.md` (schema-check example command), `README_START_HERE.md` (synthetic-fixture note) | The copy-paste `workbook_schema_check` command fails for a new user; the start-here note points at a missing file. |
