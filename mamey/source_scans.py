...
Registry overlay (B2 Phase 1):
    When bundle_support/registry_inventory_v1.9.4.json is present and self-consistent, module globals
...
#
# These literals must stay bit-identical to bundle_support/registry_inventory_v1.9.4.json's mamey_umed
...
# truth is bundle_support/registry_inventory_v1.9.4.json, loaded via registry_detector. When
