...
(registry_inventory_v1.9.4.json) instead of relying on hardcoded regex
...
def default_registry_path() -> str:
    """Locate registry_inventory_v1.9.4.json at the bundle root."""
    here = os.path.dirname(os.path.abspath(__file__))
    root = os.path.dirname(here)
    return os.path.join(root, "registry_inventory_v1.9.4.json")
