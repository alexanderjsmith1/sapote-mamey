...
is documented in docs/EXAMPLES_REFERENCE_LEDGER.md and is pending your restore-vs-rewrite decision. This
...
# Known-pending dangling examples/ targets as of v9.7.95 (see docs/EXAMPLES_REFERENCE_LEDGER.md).
