...
def test_canonical_front_door_routes_people_and_assistants():
    assert "AGENTS.md" in text("README.md")
    assert "AGENTS.md" in text("docs/BUNDLE_CAPABILITIES.md")
    assert "canonical" in text("AGENTS.md").lower()
    session = text("docs/BUNDLE_CAPABILITIES.md")
...
def test_post_mamey_complete_handback_surface_contract():
    ...
    docs = [
        ...
        text("docs/BUNDLE_CAPABILITIES.md"),
