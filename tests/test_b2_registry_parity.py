...
# registry_inventory_v1.9.4.json is intentionally absent from the CODE / analysis-free tiers
...
_REGISTRY_JSON = ROOT / "registry_inventory_v1.9.4.json"
_needs_registry = pytest.mark.skipif(
    not _REGISTRY_JSON.exists(),
    reason="registry_inventory_v1.9.4.json absent in this tier; hardcoded source_scans fallback is the validated path (registry activation is Phase-2).",
)
