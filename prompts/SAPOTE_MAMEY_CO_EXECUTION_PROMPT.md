...
**Bundle:** v9.7.432 · **Reviewed:** 2026-09-10 · **Active controller:** `docs/SAPOTE_MAMEY_BUNDLE_MONOLITH.md`
...
The boundary is the same as the standalone prompts. Claude issues ChatGPT a **typed
...
Strain: [StrainID]   Package: [zip name]   Bundle: v9.7.432
...
---
*Sapote-Mamey Bundle v9.7.432 | This prompt orchestrates the parallel loop; the role boundary and
