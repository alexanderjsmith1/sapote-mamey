...
**Bundle:** v9.7.442 · **Reviewed:** 2026-09-10 · **Active controller:** `docs/SAPOTE_MAMEY_BUNDLE_MONOLITH.md`
...
Strain: [StrainID]   Package: [zip name]   Bundle: v9.7.442
...
---
*Sapote-Mamey Bundle v9.7.442 | This prompt orchestrates the parallel loop; the role boundary and
